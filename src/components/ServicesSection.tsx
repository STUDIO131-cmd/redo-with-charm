...
const ServicesSection = () => {
  const { ref: clientsRef, isInView: clientsVisible } = useInView();

  return (
    <section id="campanhas" className="px-6 py-12 max-w-5xl mx-auto my-0">
        ...
        {clientsVisible ? (
          ...
          <div className="flex gap-4 px-4 overflow-hidden">
            {Array.from({ length: 6 }).map((_, i) => (
              <Skeleton key={i} className="flex-shrink-0 w-64 h-64 rounded-full" />
            ))}
          </div>
        )}
      </div>
      ...
      {/* Cards de serviços */}
      <div id="plano" className="grid md:grid-cols-2 gap-8">
        {/* Card 1 */}
        <motion.div
        ...
        >
          <div className="px-6 pt-6">
            <img
              ...
              src="/lovable-uploads/c18b8aa1-0fc6-4c13-8626-86f91cd6b135.png"
              loading="lazy"
              decoding="async"
            />
          </div>
        ...
        >
          <div className="px-6 pt-6">
            <img
              alt="Campanhas"
              className="w-full object-cover rounded-xl"
              src="/lovable-uploads/6a3a07e3-beec-4916-86c0-01504c6b501c.png"
              loading="lazy"
              decoding="async"
            />
          </div>
