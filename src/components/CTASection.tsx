...
const CTASection = () => {
  return (
    <section className="bg-dark-section px-6 py-20">
      <div className="max-w-2xl mx-auto text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <svg className="w-10 h-10 mx-auto mb-6 text-gold" viewBox="0 0 448 512" fill="currentColor">
        ...
        <motion.h3
          className="text-lg md:text-xl font-display text-dark-section-foreground mb-4 leading-relaxed"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          transition={{ delay: 0.2 }}
        >
          O Studio 131 existe para apoiar decisões de{" "}
          <span className="text-gold">marca e marketing</span> que precisam ser sustentadas ao longo do tempo.
        </motion.h3>

        <motion.p
          className="text-dark-section-foreground/70 text-sm font-body mb-6"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
